...
<OZWizard tab="Account" version="5.6.0-rc.0" />
...
<Callout type='warn'>
We recommend using [ERC7739](/contracts/5.x/api/utils/cryptography#ERC7739) to avoid replayability across accounts. This defensive rehashing mechanism that prevents signatures for this account to be replayed in another account controlled by the same signer. See [ERC-7739 signatures](#erc_7739_signatures).
</Callout>
