...
* [`ERC2981`](#ERC2981): NFT Royalties compatible with both ERC-721 and ERC-1155.
  * For ERC-721 consider [`ERC721Royalty`](/contracts/5.x/api/token/ERC721#ERC721Royalty) which clears the royalty information from storage on burn.
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0-rc.0/contracts/token/common/ERC2981.sol">
