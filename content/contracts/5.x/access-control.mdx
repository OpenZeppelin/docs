...
Here’s a simple example of using `AccessControl` in an [ERC-20 token](erc20) to define a 'minter' role, which allows accounts that have it to create new tokens:
