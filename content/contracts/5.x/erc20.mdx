...
An ERC-20 token contract keeps track of [_fungible_ tokens](/contracts/5.x/tokens#different-kinds-of-tokens): any one token is exactly equal to any other token; no tokens have special rights or behavior associated with them. This makes ERC-20 tokens useful for things like a **medium of exchange currency**, **voting rights**, **staking**, and more.
...
<Callout>
For a more complete discussion of ERC-20 supply mechanisms, see [Creating ERC-20 Supply](/contracts/5.x/erc20-supply).
</Callout>
