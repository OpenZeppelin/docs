...
* [ERC-20](/contracts/latest/erc20): the most widespread token standard for fungible assets, albeit somewhat limited by its simplicity.
* [ERC-721](/contracts/latest/erc721): the de-facto solution for non-fungible tokens, often used for collectibles and games.
* [ERC-1155](/contracts/latest/erc1155): a novel standard for multi-tokens, allowing for a single contract to represent multiple fungible and non-fungible tokens, along with batched operations for increased gas efficiency.
