...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/Account.sol">
...
Developers must implement the [`AbstractSigner._rawSignatureValidation`](/contracts/latest/api/utils/cryptography#AbstractSigner-_rawSignatureValidation-bytes32-bytes-) function to define the account's validation logic.
...
attacker to bypass the account's security measures. Check out [`SignerECDSA`](/contracts/latest/api/utils/cryptography#SignerECDSA), [`SignerP256`](/contracts/latest/api/utils/cryptography#SignerP256), or [`SignerRSA`](/contracts/latest/api/utils/cryptography#SignerRSA) for
...
signable hash (produced by [`Account._signableUserOpHash`](#Account-_signableUserOpHash-struct-PackedUserOperation-bytes32-)) using the abstract signer ([`AbstractSigner._rawSignatureValidation`](/contracts/latest/api/utils/cryptography#AbstractSigner-_rawSignatureValidation-bytes32-bytes-)).
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/extensions/draft-AccountERC7579.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
...
installed validator modules by calling [`IERC7579Validator.isValidSignatureWithSender`](/contracts/latest/api/interfaces#IERC7579Validator-isValidSignatureWithSender-address-bytes32-bytes-).
...
* When combined with [`ERC7739`](/contracts/latest/api/utils/cryptography#ERC7739), resolution ordering of [`AccountERC7579.isValidSignature`](#AccountERC7579-isValidSignature-bytes32-bytes-) may have an impact ([`ERC7739`](/contracts/latest/api/utils/cryptography#ERC7739) does not
...
<Callout>
when combined with [`ERC7739`](/contracts/latest/api/utils/cryptography#ERC7739), resolution ordering may have an impact ([`ERC7739`](/contracts/latest/api/utils/cryptography#ERC7739) does not call super).
...
selector and the rest of the data to be sent to the handler when calling [`IERC7579Module.onInstall`](/contracts/latest/api/interfaces#IERC7579Module-onInstall-bytes-).
...
Emits a [`IERC7579ModuleConfig.ModuleInstalled`](/contracts/latest/api/interfaces#IERC7579ModuleConfig-ModuleInstalled-uint256-address-) event.
...
selector and the rest of the data to be sent to the handler when calling [`IERC7579Module.onUninstall`](/contracts/latest/api/interfaces#IERC7579Module-onUninstall-bytes-).
...
<Callout>
This function expects the signature to be at least 20 bytes long. Panics with [`Panic.ARRAY_OUT_OF_BOUNDS`](/contracts/latest/api/utils#Panic-ARRAY_OUT_OF_BOUNDS-uint256) (0x32) otherwise.
</Callout>
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/extensions/draft-AccountERC7579Hooked.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
...
If installed, this extension will call the hook module's [`IERC7579Hook.preCheck`](/contracts/latest/api/interfaces#IERC7579Hook-preCheck-address-uint256-bytes-) before executing any operation
with [`AccountERC7579._execute`](#AccountERC7579-_execute-Mode-bytes-) (including [`AccountERC7579.execute`](#AccountERC7579-execute-bytes32-bytes-) and [`AccountERC7579.executeFromExecutor`](#AccountERC7579-executeFromExecutor-bytes32-bytes-) by default) and [`IERC7579Hook.postCheck`](/contracts/latest/api/interfaces#IERC7579Hook-postCheck-bytes-) thereafter.

<Callout>
Hook modules break the check-effect-interaction pattern. In particular, the [`IERC7579Hook.preCheck`](/contracts/latest/api/interfaces#IERC7579Hook-preCheck-address-uint256-bytes-) hook can
...
Calls [`IERC7579Hook.preCheck`](/contracts/latest/api/interfaces#IERC7579Hook-preCheck-address-uint256-bytes-) before executing the modified function and [`IERC7579Hook.postCheck`](/contracts/latest/api/interfaces#IERC7579Hook-postCheck-bytes-)
thereafter.
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/extensions/draft-ERC7821.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/utils/EIP7702Utils.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/utils/ERC4337Utils.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
...
Returns `factory` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation), or address(0) if the initCode is empty or not properly formatted.
...
Returns `factoryData` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation), or empty bytes if the initCode is empty or not properly formatted.
...
Returns `verificationGasLimit` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns `callGasLimit` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the first section of `gasFees` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the second section of `gasFees` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the total gas price for the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation) (ie. `maxFeePerGas` or `maxPriorityFeePerGas + basefee`).
...
Returns the first section of `paymasterAndData` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the second section of `paymasterAndData` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the third section of `paymasterAndData` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
Returns the fourth section of `paymasterAndData` from the [`PackedUserOperation`](/contracts/latest/api/interfaces#PackedUserOperation).
...
<a target="_blank" style={{marginTop: "1.5em"}} href="https://github.com/OpenZeppelin/openzeppelin-contracts/blob/hardhat3/contracts/account/utils/draft-ERC7579Utils.sol">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
</a>
