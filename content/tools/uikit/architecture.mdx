...
For detailed interface definitions, method signatures, and tier import rules, see [Ecosystem Adapters — Architecture](/ecosystem-adapters/architecture#capability-tiers).
