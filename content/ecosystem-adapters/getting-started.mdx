...
<Callout type="info">
**Live example**: For an end-to-end reference that combines adapters with OpenZeppelin UI in the browser, open the hosted demo at [**openzeppelin-ui.netlify.app**](https://openzeppelin-ui.netlify.app).
</Callout>
