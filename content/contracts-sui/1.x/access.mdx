...
<Cards>
  <Card href="/contracts-sui/1.x/access-control" title="RBAC">
...
- [RBAC](/contracts-sui/1.x/access-control) for role-based authorization.
...
- [Role Based Access Control guide](/contracts-sui/1.x/guides/access-control) for a full walkthrough with publishing, upgrades, and PTBs.
