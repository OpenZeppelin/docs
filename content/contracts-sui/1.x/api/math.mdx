...
<APIGithubLinkHeader
  moduleName="rounding"
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/rounding.move"
/>
...
<APIGithubLinkHeader
  ...
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/decimal_scaling.move"
/>
...
<APIItem
  functionSignature="ESafeDowncastOverflowedInt (code 0)"
...
<APIItem
  functionSignature="EInvalidDecimals (code 1)"
...
- [`u8.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u8.move)
- [`u16.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u16.move)
- [`u32.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u32.move)
- [`u64.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u64.move)
- [`u128.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u128.move)
- [`u256.move`](https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u256.move)
...
<APIGithubLinkHeader
  moduleName="u512"
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/u512.move"
/>
...
<APIItem
  functionSignature="ECarryOverflow (code 0)"
...
<APIItem
  functionSignature="EInvalidRemainder (code 3)"
...
<APIGithubLinkHeader
  moduleName="vector"
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.3.0/math/core/sources/vector.move"
/>
...
<APIItem
  functionSignature="macro fun median<$Int>($vec: &vector<$Int>, $rounding_mode: RoundingMode) -> $Int"
  id="vector-median"
  kind="public"
>
...
<APIItem
  functionSignature="median_<width>(vec: &vector<Int>, rounding_mode: RoundingMode) -> Int"
  id="vector-median_width"
  kind="public"
>
Precompiled wrappers around [`median!`](#vector-median), one per unsigned width (`median_u8`, `median_u16`, `median_u32`, `median_u64`, `median_u128`, `median_u256`). Same algorithm, results, and abort behavior, but the selection bytecode is compiled once in the library instead of being inlined at the call site. Prefer these by default; reach for the macro when a call site is gas-critical.
</APIItem>

#### Errors [!toc] [#vector-Errors]

<APIItem
  functionSignature="EMedianOfEmptyVector (code 0)"
  id="vector-EMedianOfEmptyVector"
  kind="error"
>
