---
title: openzeppelin_math API Reference
---
...
<APIItem
  ...
  kind="public"
>
Converts a `u64` amount to `u256` across decimal domains. Follows the same truncation policy when scaling down and validates decimals against the allowed range.
</APIItem>
...
### `u8`, `u16`, `u32`, `u64`, `u128`, `u256` [toc] [#unsigned-width-modules]
...
<APIItem
  ...
  kind="public"
>
Computes modular multiplicative inverse. Returns `none()` when inverse does not exist.
