...
<APIGithubLinkHeader
  ...
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.5.0/contracts/sale/sources/prefunded_sale.move"
/>
...
- [`set_vesting_schedule_params(sale, params)`](#prefunded_sale-set_vesting_schedule_params)
...
- [`mint_quote(sale, w, payment, rate)`](#prefunded_sale-mint_quote)
- [`phase(sale)`](#prefunded_sale-phase)
...
- [`vesting_schedule_params(sale)`](#prefunded_sale-vesting_schedule_params)
...
- [`VestingScheduleParamsSet`](#prefunded_sale-VestingScheduleParamsSet)
...
- [`EAllocationOverflow`](#prefunded_sale-EAllocationOverflow)
...
- [`ESoftCapMet`](#prefunded_sale-ESoftCapMet)
...
<APIItem
  functionSignature="set_vesting_schedule_params(sale: &mut PrefundedSale<..>, params: VestingScheduleParams)"
  id="prefunded_sale-set_vesting_schedule_params"
  kind="public"
>
...
<APIItem
  functionSignature="mint_quote<..>(sale: &PrefundedSale<..>, w: Curve, payment: Balance<PaymentCoin>, rate: u64) -> Quote<PaymentCoin>"
...
<APIItem functionSignature="phase(sale: &PrefundedSale<..>) -> Phase" id="prefunded_sale-phase" kind="public">
...
<APIItem functionSignature="vesting_schedule_params(sale: &PrefundedSale<..>) -> Option<VestingScheduleParams>" id="prefunded_sale-vesting_schedule_params" kind="public">
...
<APIItem functionSignature="SaleCreated(sale_id, hard_cap, soft_cap, opens_at_ms, closes_at_ms, curve_params)" id="prefunded_sale-SaleCreated" kind="event">
...
<APIItem functionSignature="VestingScheduleParamsSet(sale_id, params)" id="prefunded_sale-VestingScheduleParamsSet" kind="event">
...
<APIItem functionSignature="SaleActivated(sale_id, activated_at_ms)" id="prefunded_sale-SaleActivated" kind="event">
Emitted by `share_and_activate` when the sale goes live.
</APIItem>

<APIItem functionSignature="Purchased(sale_id, buyer, receipt_id, paid, allocation, raised_after, purchased_at_ms)" id="prefunded_sale-Purchased" kind="event">
...
<APIItem functionSignature="Claimed(sale_id, buyer, receipt_id, amount)" id="prefunded_sale-Claimed" kind="event">
Emitted for each receipt redeemed through `claim` / `claim_all` and the vesting variants.
</APIItem>

<APIItem functionSignature="Refunded(sale_id, buyer, receipt_id, amount)" id="prefunded_sale-Refunded" kind="event">
...
<APIItem functionSignature="EAllocationOverflow (code 13)" id="prefunded_sale-EAllocationOverflow" kind="error">
...
<APIItem functionSignature="ESoftCapMet (code 18)" id="prefunded_sale-ESoftCapMet" kind="error">
...
<APIGithubLinkHeader
  ...
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.5.0/contracts/sale/sources/fixed_rate_curve.move"
/>
...
<APIGithubLinkHeader
  ...
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.5.0/contracts/sale/sources/refund_vault.move"
/>
...
- [`VaultDeposit`](#refund_vault-VaultDeposit)
- [`VaultStateChanged`](#refund_vault-VaultStateChanged)
- [`VaultRelease`](#refund_vault-VaultRelease)
...
<APIItem functionSignature="RefundVaultCreated(vault_id)" id="refund_vault-RefundVaultCreated" kind="event">
Emitted by `new`.
</APIItem>

<APIItem functionSignature="VaultDeposit(vault_id, amount, locked_after)" id="refund_vault-VaultDeposit" kind="event">
...
<APIItem functionSignature="VaultRelease(vault_id, amount, locked_after)" id="refund_vault-VaultRelease" kind="event">
...
<APIGithubLinkHeader
  ...
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.5.0/contracts/sale/sources/allowlist.move"
/>
...
<APIGithubLinkHeader
  moduleName="receipt"
  link="https://github.com/OpenZeppelin/contracts-sui/blob/v1.5.0/contracts/sale/sources/receipt.move"
/>
