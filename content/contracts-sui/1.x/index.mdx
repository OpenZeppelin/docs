...
- `openzeppelin_fp_math` for 9-decimal fixed-point arithmetic and standard-normal distribution functions (`UD30x9`, `SD29x9`) backed by `u128`.
...
- Need fractional values, standard-normal probabilities, densities, or quantiles? Use [Fixed-Point Math](/contracts-sui/1.x/fixed-point).
