...
- Need controlled transfer of admin/treasury/upgrade capabilities, or role-based authorization for privileged functions? Use [Access](/contracts-sui/1.x/access).
...
- Access modules: [Access Control](/contracts-sui/1.x/access-control), [Two-Step Transfer](/contracts-sui/1.x/two-step-transfer), [Delayed Transfer](/contracts-sui/1.x/delayed-transfer).
- Learn: [Access Control](/contracts-sui/1.x/guides/access-control).
