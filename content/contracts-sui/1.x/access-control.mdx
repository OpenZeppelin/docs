...
For a full walkthrough of roles, `Auth<R>`, publishing, upgrades, and PTB usage, see the [Role Based Access Control guide](/contracts-sui/1.x/guides/access-control).
