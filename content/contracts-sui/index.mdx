...
<Cards>
  <Card href={`/contracts-sui/${latestStable}/math`} title="Math">
...
<Cards>
  <Card href={`/contracts-sui/${latestStable}/api/math`} title="Math API">
    Explore the complete math API, including all functions and types.
  </Card>
  <Card href={`/contracts-sui/${latestStable}/api/access`} title="Access API">
