...
<Cards>
  ...
  <Card href={`/contracts-sui/${latestStable}/fixed-point`} title="Fixed-Point Math">
    9-decimal fixed-point types (`UD30x9`, `SD29x9`) for arithmetic and standard-normal distribution functions.
  </Card>
...
<Cards>
  ...
  <Card href={`/contracts-sui/${latestStable}/api/fixed-point`} title="Fixed-Point Math">
    Explore the complete fixed-point API, including arithmetic, conversions, and standard-normal distribution functions.
  </Card>
