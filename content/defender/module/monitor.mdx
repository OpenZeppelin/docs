...
![Monitor Templates](/defender/monitor-templates.png)
...
<Callout type='warn'>
At this time, Monitors are supported across all [networks](#networks) except Fantom.
</Callout>
...
The request body will contain the following structure. The `MonitorConditionRequest` type from the [defender-sdk-action-client](https://www.npmjs.com/package/@openzeppelin/defender-sdk-action-client) package can be used for custom filters in Typescript.
...
![Configure Defender Monitor alerts](/defender/monitor-alert-v2.png)

### Notifications

You can create **Notifications** attached to the Monitor alerts for getting notified about the on-chain events across many channels, see more about how to create and configure them in [this section](/defender/settings/notifications).
...
* Links (this is a `[link](<span>https://</span>example.com)`)
...
![Monitor Settings](/defender/monitor-settings.png)
...
## Migration: Defender Monitor to OpenZeppelin Open Source Monitor
...
- **Custom filtering**: Write custom JavaScript filters to match specific conditions
...
2. **Set up the open source Monitor**: Follow the [installation guide](/monitor/1.1.x) to deploy Monitor on your infrastructure
3. **Import your configurations**: Use the exported configurations to recreate your monitors in the open source version
...
Here a video with the process step by step: https://www.loom.com/share/6de3d269f92c4df6abe951af69c64feb
