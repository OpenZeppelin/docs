...
| network | String | Network the relayer will connect to. Must match a network identifier defined in your network configuration files. See [Network Configuration](/relayer/1.8.x/network_configuration) for details on defining networks. |
...
See the dedicated [Network Configuration](/relayer/1.8.x/network_configuration) guide.
