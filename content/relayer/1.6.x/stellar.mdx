...
For detailed network configuration options, see the [Network Configuration](/relayer/1.6.x/network_configuration) guide.
...
For general relayer configuration options, check [User Documentation - Relayers](/relayer/1.6.x/#3_relayers).
