...
For detailed network configuration options and examples, see the [Network Configuration](/relayer/1.6.x/network_configuration) page.
...
<Callout>
Before executing the command, ensure that the `.env` and `config.json` files are configured as detailed in the [Configuration References](/relayer/1.6.x/#configuration_references) section.
</Callout>
