...
- **Confidential Token Association**: The goal of the [association](https://www.confidentialtoken.org/) is to push forward onchain confidentiality by leveraging recent advances in encryption to build a common token standard. OpenZeppelin is a [founding member](https://www.confidentialtoken.org/#members) with Zama and Inco.
