...
The vault uses a "virtual decimals offset" to add extra precision to share calculations. This helps prevent rounding errors and improves the accuracy of share-to-asset conversions, especially when the vault has few assets or shares.
...
The offset is bounded to a maximum of 10 for security and UX considerations. Values higher than 10 provide minimal practical benefits and may cause overflow errors.
