...
Even though the concept of a token is simple, they have a variety of complexities in the implementation. Because everything on TRON is just a smart contract, and there are no rules about what smart contracts have to do, the community has developed a variety of **standards** (called TIPs or TRCs, mirroring Ethereum's EIPs and ERCs) for documenting how a contract can interoperate with other contracts.
