...
<APIItemCompact
  circuitSig="_uncheckedCanProveRole(role: RoleIdentifier) → Boolean"
  kind="internal"
  modulePrefix="ShieldedAccessControl"
>
...
<APIItemCompact
  circuitSig="_updateRole(role: RoleIdentifier, accountId: AccountIdentifier, updateType: UpdateType) → []"
  kind="internal"
  stackParams="true"
  modulePrefix="ShieldedAccessControl"
>
...
<APIItemCompact
  circuitSig="_validateRole(role: RoleIdentifier, accountId: AccountIdentifier) → Boolean"
  kind="internal"
  stackParams="true"
  modulePrefix="ShieldedAccessControl"
>
...
<APIItemCompact
  circuitSig="_computeAccountId() → AccountIdentifier"
  kind="internal"
  modulePrefix="ShieldedAccessControl"
>
