...
import "./node_modules/@OpenZeppelin/shieldedAccessControl/src/ShieldedAccessControl"
...
<Callout type='info'>
  For an overview of the module, read the [ShieldedAccessControl guide](../shieldedAccessControl).
</Callout>
