...
[reusable components](/contracts-cairo/3.x/components) to build custom smart contracts, as well as ready-to-deploy [presets](/contracts-cairo/3.x/presets). You can also
find other [utilities](/contracts-cairo/3.x/api/utilities) including [interfaces and dispatchers](/contracts-cairo/alpha/interfaces) and [test utilities](/contracts-cairo/3.x/api/testing)
...
This is how it looks to build an ERC20 contract using the [ERC20 component](/contracts-cairo/3.x/erc20).
