...
<Callout type='warn'>
Before version 3.x, class hashes were computed using the `scarb --dev` profile.
</Callout>

| Name | Sierra Class Hash |
| --- | --- |
| [`AccountUpgradeable`](/contracts-cairo/3.x/api/account#AccountUpgradeable) | `{{AccountUpgradeableClassHash}}` |
| [`ERC20Upgradeable`](/contracts-cairo/3.x/api/erc20#ERC20Upgradeable) | `{{ERC20UpgradeableClassHash}}` |
| [`ERC721Upgradeable`](/contracts-cairo/3.x/api/erc721#ERC721Upgradeable) | `{{ERC721UpgradeableClassHash}}` |
| [`ERC1155Upgradeable`](/contracts-cairo/3.x/api/erc1155#ERC1155Upgradeable) | `{{ERC1155UpgradeableClassHash}}` |
| [`EthAccountUpgradeable`](/contracts-cairo/3.x/api/account#EthAccountUpgradeable) | `{{EthAccountUpgradeableClassHash}}` |
| [`UniversalDeployer`](/contracts-cairo/3.x/api/udc#UniversalDeployer) | `{{UniversalDeployerClassHash}}` |
| [`VestingWallet`](/contracts-cairo/3.x/api/finance#VestingWallet) | `{{VestingWalletClassHash}}` |
