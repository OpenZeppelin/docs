...
<APIGithubLinkHeader
    moduleName="ISRC6"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/release-v${UMBRELLA_VERSION}/packages/account/src/interface.cairo`}
/>
...
<APIGithubLinkHeader
    moduleName="ISRC9_V2"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/release-v${UMBRELLA_VERSION}/packages/account/src/extensions/interface.cairo`}
/>
