...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/governance/governor.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/governance/multisig.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/governance/timelock.cairo`}
/>
...
<APIGithubLinkHeader
  moduleName="IVotes"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/governance/votes.cairo`}
/>
