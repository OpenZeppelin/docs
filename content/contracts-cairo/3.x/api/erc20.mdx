...
<APIGithubLinkHeader
    moduleName="IERC20"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/release-v${UMBRELLA_VERSION}/packages/interfaces/src/token/erc20.cairo`}
/>
...
<APIGithubLinkHeader
    moduleName="IERC4626"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/release-v${UMBRELLA_VERSION}/packages/interfaces/src/token/erc4626.cairo`}
/>
