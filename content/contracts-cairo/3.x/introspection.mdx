...
To expose this functionality, the contract must implement the [SRC5Component](/contracts-cairo/3.x/api/introspection#SRC5Component), which defines the `supports_interface` function.
...
#[starknet::contract]
mod MyContract {
    use openzeppelin_account::interface as interface;
    use openzeppelin_introspection::src5::SRC5Component;
