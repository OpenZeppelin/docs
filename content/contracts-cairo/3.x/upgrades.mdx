...
<Callout>
We will be using the following module to implement the [IUpgradeable](/contracts-cairo/3.x/api/upgrades#IUpgradeable) interface described in the API Reference section.
</Callout>
