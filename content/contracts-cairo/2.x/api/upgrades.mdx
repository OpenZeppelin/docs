...
<APIGithubLinkHeader moduleName="IUpgradeable" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/upgrades/src/interface.cairo`} />
...
<APIGithubLinkHeader moduleName="IUpgradeAndCall" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/upgrades/src/interface.cairo`} />
