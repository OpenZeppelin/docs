...
<Callout>
We will be using the following module to implement the [IUpgradeable](/contracts-cairo/2.x/api/upgrades#IUpgradeable) interface described in the API Reference section.
</Callout>
