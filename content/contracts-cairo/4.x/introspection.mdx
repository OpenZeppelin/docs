...
To expose this functionality, the contract must implement the [SRC5Component](/contracts-cairo/4.x/api/introspection#SRC5Component), which defines the `supports_interface` function.
