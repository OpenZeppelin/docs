...
<Callout>
The dedicated package lets projects import interfaces independently from their implementation modules and use the interface package's own version line. See the [Interfaces module](../interfaces) for package versions and usage.
</Callout>
