...
<Callout>
For detailed information on the usage and implementation check the [API Reference](/contracts-cairo/4.x/api/account) section.
</Callout>
...
OpenZeppelin Contracts for Cairo provides [AccountComponent](/contracts-cairo/4.x/api/account#AccountComponent) for implementing this validation scheme.

### Usage

Constructing an account contract requires integrating both [AccountComponent](/contracts-cairo/4.x/api/account#AccountComponent) and [SRC5Component](/contracts-cairo/4.x/api/introspection#SRC5Component). The contract should also set up the constructor to initialize the public key that will be used as the account’s signer. Here’s an example of a basic contract:
...
For this the [EthAccountComponent](/contracts-cairo/4.x/api/account#EthAccountComponent) must be used.

### Usage

Constructing a secp256k1 account contract also requires integrating both [EthAccountComponent](/contracts-cairo/4.x/api/account#EthAccountComponent) and [SRC5Component](/contracts-cairo/4.x/api/introspection#SRC5Component).
...
<Callout>
The following examples use `sncast` [v0.63.0](https://github.com/foundry-rs/starknet-foundry/releases/tag/v0.63.0).
</Callout>
...
This command will output the precomputed contract address and the estimated deployment fee.
To counterfactually deploy the account, prefund the address and then deploy the custom account.
...
The following examples utilize the [StarknetJS](https://www.starknet-js.com/) library.
