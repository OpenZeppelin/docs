...
The [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) trait defines the logic for calculating the vested amount based on a given timestamp. This
...
implementation of the [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) trait.

<Callout>
There’s a ready-made implementation of the [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) trait available named [LinearVestingSchedule](/contracts-cairo/4.x/api/finance#LinearVestingSchedule).
...
The implementing contract must provide an implementation of the [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) trait. This can be achieved either by importing
...
A vesting schedule will often follow a custom formula. In such cases, the [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) trait is useful.
...
<Callout>
When using a custom [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) implementation, the [LinearVestingSchedule](/contracts-cairo/4.x/api/finance#LinearVestingSchedule) must be excluded from the imports.
</Callout>
...
Here’s an example of a vesting wallet contract with a custom [VestingSchedule](/contracts-cairo/4.x/api/finance#VestingComponent-Vesting-Schedule) implementation, where tokens
