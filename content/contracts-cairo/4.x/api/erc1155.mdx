...
<APIGithubLinkHeader
  moduleName="IERC1155"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/token/erc1155.cairo`}
/>
...
### `IERC1155Supply` [toc] [#IERC1155Supply]

<APIGithubLinkHeader
  moduleName="IERC1155Supply"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/token/erc1155.cairo`}
/>
...
- [`total_supply(token_id)`](#IERC1155Supply-total_supply)
- [`total_supply_all()`](#IERC1155Supply-total_supply_all)
- [`exists(token_id)`](#IERC1155Supply-exists)

#### Functions [!toc] [#IERC1155Supply-Functions]

<APIItem
  functionSignature="total_supply(token_id: u256) → u256"
  id="IERC1155Supply-total_supply"
  kind="external"
>
...
<APIItem
  functionSignature="total_supply_all() → u256"
  id="IERC1155Supply-total_supply_all"
  kind="external"
>
...
<APIItem
  functionSignature="exists(token_id: u256) → bool"
  id="IERC1155Supply-exists"
  kind="external"
>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/token/src/erc1155/erc1155.cairo`}
/>
...
#### Token URI [!toc] [#ERC1155Component-Token-URI]

The metadata implementation delegates URI resolution to [`ERC1155TokenURITrait`](#ERC1155Component-ERC1155TokenURITrait). Contracts can use the default implementation or provide an extension-specific implementation such as [`ERC1155URIStorageImpl`](#ERC1155URIStorageComponent-ERC1155URIStorageImpl).

<APIItem
  functionSignature="ERC1155TokenURITrait trait"
  id="ERC1155Component-ERC1155TokenURITrait"
  kind="trait"
>
```rust
...
<APIItem
  functionSignature="ERC1155TokenURIDefaultImpl impl"
  id="ERC1155Component-ERC1155TokenURIDefaultImpl"
  kind="impl"
>
```rust
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/token/src/erc1155/erc1155_receiver.cairo`}
/>
...
### `ERC1155SupplyComponent` [toc] [#ERC1155SupplyComponent]

<APIGithubLinkHeader
  moduleName="ERC1155SupplyComponent"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/token/src/erc1155/extensions/erc1155_supply.cairo`}
/>
...
The implementing contract must forward every `ERC1155HooksTrait::after_update` call to [`ERC1155SupplyComponent::after_update`](#ERC1155SupplyComponent-after_update). Adding this component in an upgrade to a contract with an existing token supply leaves the new counters inconsistent and is not supported.

Embeddable Implementations

- [`ERC1155SupplyImpl`](#ERC1155SupplyComponent-ERC1155SupplyImpl)

Internal Implementations

- [`InternalImpl`](#ERC1155SupplyComponent-InternalImpl)

#### Storage [!toc] [#ERC1155SupplyComponent-Storage]

<APIItem
  functionSignature="ERC1155Supply_total_supply: Map<u256, u256>"
  id="ERC1155SupplyComponent-ERC1155Supply_total_supply"
  kind="storage"
>
...
<APIItem
  functionSignature="ERC1155Supply_total_supply_all: u256"
  id="ERC1155SupplyComponent-ERC1155Supply_total_supply_all"
  kind="storage"
>
Aggregate supply across all token IDs.
</APIItem>

#### `ERC1155SupplyImpl` [!toc] [#ERC1155SupplyComponent-ERC1155SupplyImpl]

- [`total_supply(self, token_id)`](#ERC1155SupplyComponent-total_supply)
- [`total_supply_all(self)`](#ERC1155SupplyComponent-total_supply_all)
- [`exists(self, token_id)`](#ERC1155SupplyComponent-exists)

<APIItem
  functionSignature="total_supply(self: @ContractState, token_id: u256) → u256"
  id="ERC1155SupplyComponent-total_supply"
  kind="external"
>
Returns the total supply of `token_id`.
</APIItem>
...
<APIItem
  functionSignature="total_supply_all(self: @ContractState) → u256"
  id="ERC1155SupplyComponent-total_supply_all"
  kind="external"
>
Returns the aggregate supply across all token IDs.
</APIItem>
...
<APIItem
  ...
  id="ERC1155SupplyComponent-exists"
  kind="external"
>
Returns whether the total supply of `token_id` is greater than zero.
</APIItem>

#### `InternalImpl` [!toc] [#ERC1155SupplyComponent-InternalImpl]

<APIItem
  functionSignature="after_update(ref self: ContractState, from: ContractAddress, to: ContractAddress, token_ids: Span<u256>, values: Span<u256>)"
  id="ERC1155SupplyComponent-after_update"
  kind="internal"
>
...
Call this function from the implementing contract's [`ERC1155HooksTrait::after_update`](#ERC1155Component-after_update) hook after every transfer, mint, or burn.
</APIItem>

### `ERC1155URIStorageComponent` [toc] [#ERC1155URIStorageComponent]

<APIGithubLinkHeader
  moduleName="ERC1155URIStorageComponent"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/token/src/erc1155/extensions/erc1155_uri_storage.cairo`}
/>
...
Extension that supports token-specific URI suffixes. Use its [`ERC1155URIStorageImpl`](#ERC1155URIStorageComponent-ERC1155URIStorageImpl) as the contract's `ERC1155TokenURITrait` implementation instead of `ERC1155TokenURIDefaultImpl`.

Implementations

- [`ERC1155URIStorageImpl`](#ERC1155URIStorageComponent-ERC1155URIStorageImpl)

Internal Implementations

- [`InternalImpl`](#ERC1155URIStorageComponent-InternalImpl)

#### Storage [!toc] [#ERC1155URIStorageComponent-Storage]

<APIItem
  functionSignature="ERC1155URIStorage_base_uri: ByteArray"
  id="ERC1155URIStorageComponent-ERC1155URIStorage_base_uri"
  kind="storage"
>
...
<APIItem
  functionSignature="ERC1155URIStorage_token_uris: Map<u256, ByteArray>"
  id="ERC1155URIStorageComponent-ERC1155URIStorage_token_uris"
  kind="storage"
>
Token-specific URI suffixes keyed by token ID.
</APIItem>

#### `ERC1155URIStorageImpl` [!toc] [#ERC1155URIStorageComponent-ERC1155URIStorageImpl]

<APIItem
  functionSignature="uri(self: @ERC1155Component::ComponentState, token_id: u256) → ByteArray"
  id="ERC1155URIStorageComponent-uri"
  kind="impl"
>
Returns the URI for `token_id`. When a token-specific suffix is set, the result is the extension's base URI concatenated with that suffix. Otherwise, it returns the base URI stored by [`ERC1155Component`](#ERC1155Component).
</APIItem>

#### `InternalImpl` [!toc] [#ERC1155URIStorageComponent-InternalImpl]

- [`set_token_uri(self, token_id, token_uri)`](#ERC1155URIStorageComponent-set_token_uri)
- [`set_base_uri(self, base_uri)`](#ERC1155URIStorageComponent-set_base_uri)

<APIItem
  functionSignature="set_token_uri(ref self: ContractState, token_id: u256, token_uri: ByteArray)"
  id="ERC1155URIStorageComponent-set_token_uri"
  kind="internal"
>
Stores `token_uri` as the token-specific suffix for `token_id` and emits the core [`URI`](#ERC1155Component-URI) event with the resolved URI.
</APIItem>

<APIItem
  functionSignature="set_base_uri(ref self: ContractState, base_uri: ByteArray)"
  id="ERC1155URIStorageComponent-set_base_uri"
  kind="internal"
>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/presets/src/erc1155.cairo`}
/>
...
- [`ERC1155MixinImpl`](#ERC1155Component-Embeddable-Impls-ERC1155MixinImpl)
