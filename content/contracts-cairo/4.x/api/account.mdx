...
<APIGithubLinkHeader
    moduleName="ISRC6"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/account/accounts.cairo`}
/>
...
<APIGithubLinkHeader
    moduleName="ISRC9_V2"
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/account/src9.cairo`}
/>
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/account/src/account.cairo`}
/>
...
- [`SRC5Impl`](#AccountComponent-Embeddable-Impls-SRC5Impl)
...
- [`__validate_deploy__(self, class_hash, contract_address_salt, public_key)`](#AccountComponent-__validate_deploy__)
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/account/src/eth_account.cairo`}
/>
...
- [`SRC5Impl`](#EthAccountComponent-Embeddable-Impls-SRC5Impl)
...
- [`__validate_deploy__(self, class_hash, contract_address_salt, public_key)`](#EthAccountComponent-__validate_deploy__)
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/account/src/extensions/src9/src9.cairo`}
/>
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/presets/src/account.cairo`}
/>
...
- [`AccountMixinImpl`](#AccountComponent-Embeddable-Impls-AccountMixinImpl)
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/presets/src/eth_account.cairo`}
/>
...
- [`EthAccountMixinImpl`](#EthAccountComponent-Embeddable-Impls-EthAccountMixinImpl)
