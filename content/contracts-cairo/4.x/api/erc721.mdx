...
<APIItem
    ...
    kind="external"
>
Transfer ownership of `token_id` from `from` to `to`, checking first that `to` is aware of the ERC721 protocol to prevent tokens being locked forever. For information regarding how contracts communicate their awareness of the ERC721 protocol, see [Receiving Tokens](../erc721#receiving-tokens).
...
- [`SRC5Impl`](#ERC721Component-Embeddable-Impls-SRC5Impl)
...
Tokens start existing when they are minted ([mint](#ERC721Component-mint)), and stop existing when they are burned ([burn](#ERC721Component-burn)).
</APIItem>
...
- [`SRC5Impl`](./introspection#SRC5Component-SRC5Impl)
...
<APIItem
  functionSignature="onERC721Received(self: @ContractState, operator: ContractAddress, from: ContractAddress, tokenId: u256, data: Span<felt252>) -> felt252"
...
#### Embeddable functions [!toc] [#ERC721EnumerableComponent-Embeddable-functions]
...
#### Internal functions [!toc] [#ERC721EnumerableComponent-Internal-functions]
...
- [`ERC721MixinImpl`](#ERC721Component-Embeddable-Impls-ERC721MixinImpl)
...
#### Constructor [!toc] [#ERC721Upgradeable-constructor-section]
...
#### External functions [!toc] [#ERC721Upgradeable-external-functions]
