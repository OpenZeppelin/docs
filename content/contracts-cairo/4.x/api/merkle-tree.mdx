...
### `merkle_proof` [toc] [#merkle_proof]

<APIGithubLinkHeader moduleName="merkle_proof" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/merkle_tree/src/merkle_proof.cairo`} />
...
#### Functions [!toc] [#merkle_proof-Functions]
...
<APIGithubLinkHeader moduleName="hashes" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/merkle_tree/src/hashes.cairo`} />
