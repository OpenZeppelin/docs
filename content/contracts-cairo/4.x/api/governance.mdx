...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/governance/governor.cairo`}
/>
...
- [`cancel(calls, description_hash)`](#IGovernor-cancel)
...
- [`cast_vote_by_sig(proposal_id, support, voter, signature)`](#IGovernor-cast_vote_by_sig)
- [`cast_vote_with_reason_and_params_by_sig(proposal_id, support, voter, reason, params, signature)`](#IGovernor-cast_vote_with_reason_and_params_by_sig)
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/governance/multisig.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/governance/timelock.cairo`}
/>
...
<APIGithubLinkHeader
  moduleName="IVotes"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/governance/votes.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/governor.cairo`}
/>
...
- [`cancel(self, calls, description_hash)`](#GovernorComponent-cancel)
...
- [`cast_vote_by_sig(self, proposal_id, support, voter, signature)`](#GovernorComponent-cast_vote_by_sig)
- [`cast_vote_with_reason_and_params_by_sig(self, proposal_id, support, voter, reason, params, signature)`](#GovernorComponent-cast_vote_with_reason_and_params_by_sig)
...
- [`ProposalQueued(proposal_id, eta_seconds)`](#GovernorComponent-ProposalQueued)
...
<APIItem
  functionSignature="validate_state(self: @ContractState, proposal_id: felt252, allowed_states: Span<ProposalState>)"
...
<APIItem
  functionSignature="use_nonce(ref self: ContractState, voter: ContractAddress) → felt252"
...
<APIItem
  functionSignature="_propose(ref self: ContractState, calls: Span<Call>, description: @ByteArray, proposer: ContractAddress) → felt252"
...
<APIItem
  functionSignature="_cancel(ref self: ContractState, proposal_id: felt252, description_hash: felt252)"
...
## Governor extensions [#governor_extensions]

The Governor component can (and must) be extended by implementing the [extensions traits](#GovernorComponent-Extensions-Traits) to add the desired functionality. This can be achieved by directly implementing the traits on your contract, or by using a set of ready-to-use extensions provided by the library, which are presented below.

### `GovernorCoreExecutionComponent` [toc] [#GovernorCoreExecutionComponent]

<APIGithubLinkHeader
  moduleName="GovernorCoreExecutionComponent"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_core_execution.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_counting_simple.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_settings.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_votes.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_votes_quorum_fraction.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/governor/extensions/governor_timelock_execution.cairo`}
/>
...
<APIItem
  functionSignature="get_timelock_id(self: @ContractState, proposal_id: felt252) → felt252"
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/multisig/multisig.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/timelock/timelock_controller.cairo`}
/>
...
- [`TimelockImpl`](#TimelockControllerComponent-TimelockImpl)
- [`SRC5Impl`](#TimelockControllerComponent-SRC5Impl)
- [`AccessControlImpl`](#TimelockControllerComponent-AccessControlImpl)
- [`AccessControlCamelImpl`](#TimelockControllerComponent-AccessControlCamelImpl)
...
- [`hasRole(self, role, account)`](./access#AccessControlComponent-hasRole)
- [`getRoleAdmin(self, role)`](./access#AccessControlComponent-getRoleAdmin)
- [`grantRole(self, role, account)`](./access#AccessControlComponent-grantRole)
- [`revokeRole(self, role, account)`](./access#AccessControlComponent-revokeRole)
- [`renounceRole(self, role, account)`](./access#AccessControlComponent-renounceRole)
...
<APIItem
  functionSignature="initializer(ref self: ContractState, min_delay: u64, proposers: Span<ContractAddress>, executors: Span<ContractAddress>, admin: ContractAddress)"
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/governance/src/votes/votes.cairo`}
/>
