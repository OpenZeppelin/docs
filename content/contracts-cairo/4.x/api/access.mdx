...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/access/accesscontrol.cairo`}
/>
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/access/accesscontrol_default_admin_rules.cairo`}
/>
...
<APIItem
    functionSignature="DefaultAdminDelayChangeCanceled()"
    id="IAccessControlDefaultAdminRules-DefaultAdminDelayChangeCanceled"
    kind="event"
>
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/access/src/ownable/ownable.cairo`}
/>
...
- [`transferOwnership(self, newOwner)`](#OwnableComponent-two-step-transferOwnership)
...
<APIItem
    ...
    id="OwnableComponent-transferOwnership"
    kind="external"
>
...
<APIItem
    ...
    id="OwnableComponent-renounceOwnership"
    kind="external"
>
...
<APIItem
    functionSignature="acceptOwnership(ref self: ContractState)"
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/access/src/accesscontrol/accesscontrol.cairo`}
/>
...
- [`SRC5Impl`](#AccessControlComponent-Embeddable-Impls-SRC5Impl)
...
<APIGithubLinkHeader
    ...
    link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/access/src/accesscontrol/extensions/accesscontrol_default_admin_rules.cairo`}
/>
...
- [`SRC5Impl`](#AccessControlDefaultAdminRulesComponent-Embeddable-Impls-SRC5Impl)
...
<APIItem
    functionSignature="DefaultAdminDelayChangeCanceled()"
    id="AccessControlDefaultAdminRulesComponent-DefaultAdminDelayChangeCanceled"
    kind="event"
>
