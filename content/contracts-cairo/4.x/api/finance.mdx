...
<APIGithubLinkHeader
  moduleName="IVesting"
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/interfaces/src/finance/vesting.cairo`}
/>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/finance/src/vesting/vesting.cairo`}
/>
...
<APIItem
  ...
  kind="internal"
>
Returns the vested amount that's calculated using the [VestingSchedule](#VestingComponent-Vesting-Schedule-functions) trait implementation.
</APIItem>
...
<APIGithubLinkHeader
  ...
  link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${API_SOURCE_VERSION}/packages/presets/src/vesting.cairo`}
/>
