...
To get started immediately, see [Quickstart](/monitor/1.1.x/quickstart).
...
For more information about custom scripts, see [Custom Scripts Section](/monitor/1.1.x/scripts).
...
The monitor implements a comprehensive error handling system with rich context and tracing capabilities. For detailed information about error handling, see [Error Handling Guide](/monitor/1.1.x/error).
...
* Monitor performance depends on network congestion and RPC endpoint reliability.
  * View the [list of RPC calls](/monitor/1.1.x/rpc#list_of_rpc_calls) made by the monitor.
...
* See performance considerations about custom scripts [here](/monitor/1.1.x/scripts#performance_considerations).
