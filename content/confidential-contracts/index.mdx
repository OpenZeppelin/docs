...
<Callout>
All contracts must set their respective co-processor configuration during construction (or initialization). This can be done automatically by inheriting [`ZamaEthereumConfig`](https://github.com/zama-ai/fhevm/blob/e446c370002f62f193bbb5eb4075dea5d29a6996/library-solidity/config/ZamaConfig.sol#L96-L104).
</Callout>
