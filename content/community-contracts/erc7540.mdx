...
<Callout>
For `requestRedeem`, authorization can come from **either** the operator system or standard ERC-20 approval. This dual authorization is consistent with [ERC-6909](https://eips.ethereum.org/EIPS/eip-6909). Operators are not subject to allowance restrictions, while non-infinite ERC-20 approvals are consumed.
</Callout>
