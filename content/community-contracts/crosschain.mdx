...
For more details of how the duplex gateway works, see [how to send and receive messages with the  Axelar Network](/community-contracts/crosschain#axelar-network) below
